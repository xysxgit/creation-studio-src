...
const logs = [];
page.on('console', (m) => { const t = m.text(); if (t.includes('[live]')) logs.push(t); });
...
console.log('画后:', await page.locator('.annotation-g').count());
...
console.log('滑到350(未松手):', await page.locator('.annotation-g').count());
await page.mouse.move(wb.x + 450, wb.y + 400, { steps: 3 }); await page.waitForTimeout(300);
console.log('滑到450(未松手):', await page.locator('.annotation-g').count());
await page.mouse.up();
